// FSR 1.0 (EASU/RCAS) — AMD FidelityFX, MIT license.
// WGSL compute port: https://github.com/firdawolf/AMD-FSR1-wgpu-shader (MIT).
// Vendored for the video/BG upscale path; opaque content only (alpha := 1).
